...
<header>
    <nav>
    <a href="../product/product_overzicht.php">producten </a>
    <?php if(isset($_SESSION['admin']) && $_SESSION['admin'] === true) { ?> 
    <a href="../product/product_toevoegen.php">product toevoegen </a>
    <a href="../product/product_verwijderen.php">product verwijderen </a>
    <a href="user_add.php">admin toevoegen</a>
    <a href="user_delete.php">admin verwijderen</a>
    <a href="user_overview.php">admin overview</a>
...
<table style="border: 1px solid black;">
    ...
    <?php 
    $sql = "SELECT * FROM `user`  WHERE rechten = 2 order by `id` asc ";
